export const masterCharmList = [
    ...
    },
    {
        ...
        effectText: "Increases invincibility duration after being hit to 1.75 seconds (from 1.3 seconds). Reduces hit recoil to .08 seconds (from .2 seconds).",
    },
    ...
    },
    {
        ...
        effectText:
            "Increases Vengeful Spirit/Shade Soul damage by 33%. Increases Desolate Dive damage by 51% and Descending Dark damage by 47%. Increases Howling Wraiths/Abyss Shriek damage by 50%. Increases the size of Vengeful Spirit/Shade Soul.",
    },
    {
        id: "soulEater",
        name: "Soul Eater",
    ...
    },
    {
        ...
        //[Without any Charms, the Knight's speed is 8.3. With Sprintmaster, it is 10. With Sprintmaster and Dashmaster, it is 11.5.]
        effectText: "Increases run speed by ~20%.",
    },
    {
        id: "grubsong",
        name: "Grubsong",
    ...
    // },
    {
        ...
        //[The damage is rounded to the nearest integer, or to the nearest even integer if halfway between two. This results in 8/14/20/26/32 damage at Nail upgrades 0/1/2/3/4.]
        effectText: "Increases Nail damage by 50%.",
    },
    {
        id: "spellTwister",
        name: "Spell Twister",
    ...
    },
    {
        ...
        effectText: "Decreases Nail attack duration to 0.28 seconds (from 0.35 seconds). Decreases Nail attack cooldown to 0.25 seconds (from 0.41 seconds).",
    },
    {
        id: "longnail",
        name: "Longnail",
        ...
        effectText: "Increases Nail range by 15%.",
    },
    {
        id: "markOfPride",
        name: "Mark of Pride",
    ...
    },
    {
        ...
        effectText: "Increases Nail damage by 75% when at 1 Mask. This effect is also applied to Nail Arts.",
    },
    {
        id: "thornsOfAgony",
    ...
    },
    {
        ...
        effectText: "Spawns toxic clouds that deal ~3 damage and last 1.1 seconds. A new one spawns at the Knight's location every 0.75 seconds.",
    },
    {
        id: "glowingWomb",
        name: "Glowing Womb",
    ...
    },
    {
        ...
        effectText: "Focus heals 2 Masks of Health while increasing Focus time by 65% to 1.47015 seconds (from 0.891 seconds).",
    },
    {
        id: "lifebloodHeart",
    ...
    },
    {
        ...
        //The 40% increase in Masks granted by Joni's Blessing only takes into account the base Masks and the two Masks added by Fragile/Grimm Troupe content Unbreakable Heart. Masks added by Lifeblood Heart and Lifeblood Core are not included in the calculation.
        effectText: "Increase Masks by 40% (rounded up), and all Masks become Lifeblood.",
    },
    {
        id: "hiveblood",
        name: "Hiveblood",
    ...
    },
    {
        ...
        //[Without any Charms, Spore Shroom deals damage every 0.15 seconds. With Defender's Crest, it deals 2 damage every 0.2 seconds.]
        effectText: "Focus releases a cloud of spores dealing ~26 damage over 4.1 seconds. It cannot be used again until either 4.25 seconds pass or the Knight takes damage.",
    },
    {
        id: "sharpShadow",
        name: "Sharp Shadow",
    ...
    },
    {
        ...
        effectText: "Reduces the charge time of Nail Arts to 0.75 seconds (from 1.35 seconds).",
    },
    {
        id: "weaversong",
        name: "Weaversong",
        ...
        effectText: "Summons 3 small Weaverlings that attack enemies for 3 damage per hit.",
    },
    {
        id: "dreamWielder",
        name: "Dream Wielder",
        ...
        effectText: "Gain +33 additional SOUL when hitting enemies with the Dream Nail (from 33 to 66). Reduces the time needed to attack with the Dream Nail by ~37.5%.",
    },
    {
        id: "dreamshield",
        name: "Dreamshield",
